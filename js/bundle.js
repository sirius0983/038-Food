...
function calc() {
    ...
    function calcTotal() {
        ...
        if (sex === 'female') {
            ...
            result.textContent = Math.round((83.36 + (13.4 * weight) + (4.8 * height) - (5.7 * age)) * ratio);
        }
    }
...
document.addEventListener('DOMContentLoaded', () => {
    let modalTimerID = setTimeout(() => (0,_modules_modal__WEBPACK_IMPORTED_MODULE_1__.openModal)('.modal', modalTimerID), 50000)
    ...
    ;(0,_modules_timer__WEBPACK_IMPORTED_MODULE_5__.default)('.timer', '2021-02-21')
